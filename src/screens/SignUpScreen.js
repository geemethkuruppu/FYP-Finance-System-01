    ...
    return (
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={[styles.container, { backgroundColor: colors.background }]}>
                ...
                {/* Ambient Glows */}
                <View style={[styles.glowTop, { backgroundColor: colors.secondary }]} />
                <View style={[styles.glowBottom, { backgroundColor: colors.primary }]} />
                ...
                >
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subtitle}>Join us and start building wealth</Text>
                    </View>
                    ...
                    <View style={styles.footer}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate("Login")}>
                            <Text style={[styles.signupText, { color: colors.secondary }]}>Log In</Text>
                        </TouchableOpacity>
                    </View>
                </KeyboardAvoidingView>
            </View>
